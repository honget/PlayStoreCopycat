...
//        appList.add(new Appli(6, "스왐피(Swampy)", "Disney", 4, 3000, false));
        ...
        appList.add(new Appli(1, "아스팔트 8: 에어본", "GameLoft", 5, 6000));
        appList.add(new Appli(2, "MineCraft - Pocket Edition", "Mojang", 4, 5000));
        appList.add(new Appli(3, "아스팔트 7: 하트", "GameLoft", 2, 1000));
        appList.add(new Appli(4, "팔라독(Paladog)", "FazeCat", 3, 1087));
        appList.add(new Appli(5, "Plants Vs. Zombies", "EA Swiss Sarl", 1, 2000));
        appList.add(new Appli(6, "스왐피(Swampy)", "Disney", 4, 3000));
