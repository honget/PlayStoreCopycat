...
//                Intent intent = new Intent(Intent.ACTION_DIAL, phoneUri);
        ...
        act.smsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Uri smsUri = Uri.parse("smsto:010-1234-5678");
...
//        });
        ...
        //연습 문제, 날짜를 누르고 선택하면 반영되기
        //시간을 누르면 선택하면 반영 되게 ,AM /PM을 오전/ 오후로 변경
            ...
            public void onClick(View v) {
                DatePickerDialog dpd = new DatePickerDialog(AppDetailActivity.this, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        act.dateTxt.setText(sdf.format(cal.getTimeInMillis()));
            ...
            public void onClick(View v) {
                TimePickerDialog tpd = new TimePickerDialog(AppDetailActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        ...
                        SimpleDateFormat sdf = new SimpleDateFormat("a h 시 m분", Locale.KOREA);

                        act.timeTxt.setText(sdf.format(cal.getTimeInMillis()));
